...
Catppuccin Mocha throughout · fast-in/soft-out animations · SUPER-centric keys.
...
```bash
git clone https://github.com/cartermccann/atlas-dotfiles ~/atlas-dotfiles
cd ~/atlas-dotfiles
...
- **`atlas-theme`** — omarchy-style unified theme switcher (Catppuccin / Gruvbox /
  Tokyo Night / Everforest) that swaps colors across mango, waybar, ghostty,
  alacritty, foot, rofi, mako and reloads them live.
